...
public class AccountantFirm implements Company {
    ...
    public AccountantFirm(int numberOfEmployees) {
    ...
    public void averageSalary() {
        ...
        System.out.println("Average salary of accountant employees: " + average);
    }
    ...
    public void maxSalary() {
        ...
        System.out.println("Max salary of the accountant employee: " + max);
    }
    ...
    public void minSalary() {
        ...
        System.out.println("Min salary of the accountant employee: " + min);
    }
}
